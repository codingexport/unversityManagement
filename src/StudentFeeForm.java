...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        String course[] = {"B-Teach", "BCA", "BBA", "BCOM", "bsc", "Msc", "MBA", "BCOM", "MCOM", "BA","MA"};
        ...
        String semester[] = {"semseter1", "semseter2", "semseter3", "semseter4", "semseter5", "semseter6", "semseter7", "semseter8" };
