...
public class AddTeacher extends JFrame implements ActionListener {
   ...
   AddTeacher() {
      ...
      JLabel lblimpolID = new JLabel("Teacher Id");
      lblimpolID.setBounds(50, 200, 200, 30);
      lblimpolID.setFont(new Font("serif", 1, 20));
      this.add(lblimpolID);
      this.labelImpolId = new JLabel("1533" + this.first4);
      this.labelImpolId.setBounds(200, 200, 200, 30);
      this.labelImpolId.setFont(new Font("serif", 1, 20));
      this.add(this.labelImpolId);
      ...
      JLabel lblcourse = new JLabel("Colification");
   ...
   public void actionPerformed(ActionEvent ae) {
      if (ae.getSource() == this.submit) {
         ...
         String impolId = this.labelImpolId.getText();
         ...
         String colification = (String)this.cbcourse.getSelectedItem();
         String dipartment = (String)this.cbbranch.getSelectedItem();

         try {
            String query = "insert into teacher values('" + name + "', '" + fname + "', '" +impolId + "', '" + dob + "', '" + address + "', '" + phone + "', '" + email + "', '" + x + "', '" + xii + "', '" + aadhar + "', '" + colification + "', '" + dipartment+ "')";
            conn con = new conn();
